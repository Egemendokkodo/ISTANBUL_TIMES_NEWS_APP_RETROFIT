...
public class EconomyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.economylayout,null);

        recyclervieweconomy =v.findViewById(R.id.recyclervieweconomy);
        modelClassArrayList=new ArrayList<>();
        recyclervieweconomy.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new RecyclerViewAdapter(getContext(),modelClassArrayList);
        recyclervieweconomy.setAdapter(adapter);
        findNews();
        return v;
    }
